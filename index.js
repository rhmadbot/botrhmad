...
async function starts() {
	...
	client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `[ *SELAMAT DATANG DI GC ${mdata.subject}* ] *Member baru jangan sok kerass,Sok asik,gausah caperr,disuruh intro ya intro gk usah bnyak bacott*		\n╔╦╦╦═╦╗╔═╦═╦══╦═╗ \n║║║║═╣║║╔╣║║║║║═╣ \n║║║║═╣╚╣╚╣║║║║║═╣ \n╚══╩═╩═╩═╩═╩╩╩╩═╝                    \n*Baca dekripsi grub njg,ɪɴᴛʀᴏ/ᴅɪᴋɪᴄᴋ:*      \n✰❛New Member Intro✰❛   \n╔══════════════                   \n║❖➥ *Nama :*                        \n║❖➥ *Umur:*                         \n║❖➥ *Askot:*                         \n║❖➥ *Hobi:*                        \n║❖➥ *Status:*                         \n║ *SEMOGA BETAH GAIS,!*                     \n╚══════════════ `
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["6285251159773@s.whatsapp.net"] // replace this with your number
